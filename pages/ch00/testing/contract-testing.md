...
<<<<<<<< HEAD:src/getting-started/testing/contract-testing.md
```cairo
{{#include ../../../listings/getting-started/testing_how_to/src/contract.cairo:contract}}
========
```rust
// [!include ~/listings/getting-started/testing_how_to/src/contract.cairo:contract]
>>>>>>>> 261b110 (feat: migrate frontend framework from mdbook to vocs  (#185)):pages/ch00/testing/contract-testing.md
```
